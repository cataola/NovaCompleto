...
$pageTranslations = $translations['inspeccionLabores']; // Obtén las traducciones específicas para la página principal
?>
...
<head>
    ...
    <title>Inspeccion de Labores - Nova Analytics</title>
    ...
    <link rel="stylesheet" href="estilosInspeccionLabores.css">
...
<body>
    ...
    <div id="bannerAgricola" class="container-fluid p-0 position-relative">
        ...
        <div  id="bannerAgricola-title" class="position-absolute top-50 start-50 translate-middle text-white">
            <h3  class="fw-bold"><?php echo $pageTranslations["txtInspeccion"]; ?></h3>
        </div>
    </div>

    <div id="informacion-seccion">
        <div class="textos">
            <h3><?php echo $pageTranslations["txtServicio"]; ?></h3>
            <h1><?php echo $pageTranslations["txt2Inspeccion"]; ?></h1>
            <div class="txt">
                <p><?php echo $pageTranslations["txt3Inspeccion"]; ?></p>
                <a href="#formulario-seccion" class="btnCotiza"><?php echo $pageTranslations["txtBtnCotiza"]; ?></a>
                
            </div>
            <img src="imgs/cardsServicios/imgLabores.jpg" alt="_blank">
        </div>
    </div>

    <div id="contenedor2-cards">
        <div id="titCards2">
            <h1><?php echo $pageTranslations["txtOfrecemos"]; ?></h1>
            <h4><?php echo $pageTranslations["txtComplementos"]; ?></h4>
        </div>
        <div class="contCards2">
            <div class="card2-nova card-custom">
                <div class="icon2-nova-title d-flex align-items-center justify-content-center">
                    ...
                    <h3><?php echo $pageTranslations["txtSoftware"]; ?></h3>
                </div>
                ...
                <div class="card2-nova-body">
                    <p><?php echo $pageTranslations["txt2Software"]; ?></p>
                    <br><br><a href="captacionData.html" class="button"><?php echo $pageTranslations["txtBtnCaptacion"]; ?></a>
                </div>
            </div>
            <div class="card2-nova card-custom">
                <div class="icon2-nova-title d-flex align-items-center justify-content-center">
                    <a href="#" id="servicios-icon"><img src="imgs/cardsServicios/almacenamiento.png" alt="Almacenamiento de Data"></a>
                    <h3><?php echo $pageTranslations["txtAlmacenamiento"]; ?></h3>
                </div>
                <img src="imgs/cardsServicios/imgAlmacenamiento.png" class="card-img-top" alt="Imagen de Almacenamiento de Data">
                <div class="card2-nova-body">
                    <p><?php echo $pageTranslations["txt2Almacenamiento"]; ?></p>
                    <a href="almacenamientoData.html" class="button"><?php echo $pageTranslations["txtBtnAlmacenamiento"]; ?></a>
                </div>
            </div>
            <div class="card2-nova card-custom">
                <div class="icon2-nova-title d-flex align-items-center justify-content-center">
                    <a href="#" id="servicios-icon"><img src="imgs/cardsServicios/dash.png" alt=""></a>
                    <h3><?php echo $pageTranslations["txtDash"]; ?></h3>
                </div>
                    <img src="imgs/cardsServicios/imgDash.jpeg" class="card-img-top" alt="">
                <div class="card2-nova-body">
                    <p><?php echo $pageTranslations["txt2Dash"]; ?></p>
                    <a href="dashboardTiempoReal.html" class="button"><?php echo $pageTranslations["txtBtnDash"]; ?></a>
                </div>
            </div>
            ...
            <div class="card2-nova card-custom">
                <div class="icon2-nova-title d-flex align-items-center justify-content-center">
                    ...
                    <h3><?php echo $pageTranslations["txtReportes"]; ?></h3>
                </div>
                <img src="imgs/cardsServicios/imgReportes.jpg" class="card-img-top"  alt="Imagen de Reportes con Data Insight">
                <div class="card2-nova-body">
                    <p><?php echo $pageTranslations["txt2Reportes"]; ?></p>
                    <br><br><a href="reportesData.html" class="button"><?php echo $pageTranslations["txtBtnReportes"]; ?></a>
                </div>
            </div>
            <div class="card2-nova card-custom">
                <div class="icon2-nova-title d-flex align-items-center justify-content-center">
                    <a href="#" id="servicios-icon"><img src="imgs/cardsServicios/data.png" alt="Data Analytics"></a>
                    <h3><?php echo $pageTranslations["txtData"]; ?></h3>
                </div>
                <img src="imgs/cardsServicios/imgData.jpg" class="card-img-top" alt="Imagen de Data Analytics">
                <div class="card2-nova-body">
                    <p><?php echo $pageTranslations["txt2Data"]; ?></p>
                    <br><a href="dataAnalytics.html" class="button"><?php echo $pageTranslations["txtBtnData"]; ?></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row w-100">
            ...
            <div id="contenedor-encuentranos" class="col-md-6 d-flex flex-column justify-content-start">
                <div class="txtSeccion">
                    <h1><?php echo $pageTranslations["txtCotiza"]; ?></h1>
                    <h5><?php echo $pageTranslations["txt2Cotiza"]; ?>__</h5>
                    <p><?php echo $pageTranslations["txt3Cotiza"]; ?></p>
                </div>
                ...
                <div id="container-encuentranos" class="d-flex">
                    <div class="contacto"> <!-- Espaciado a la derecha -->
                        <h4 class="small"><?php echo $pageTranslations["txtEncuentranos"]; ?></h4>
                        <div class="d-flex align-items-center mb-2">
                            <img src="imgs/iconos/imgMensajeNaranjo.png" alt="Correo" id="imgCorreo" class="me-2">
                            <p id="txtCorreo" class="mb-0"><?php echo $pageTranslations["txtCorreo"]; ?></p>
                        </div>
                        <div class="d-flex align-items-center">
                            <img src="imgs/iconos/imgTelefonoNaranjo.png" alt="Teléfono" id="imgTelefono" class="me-2">
                            <p id="txtTelefono" class="mb-0"><?php echo $pageTranslations["txtTelefono"]; ?></p>
                        </div>
                    </div>
    
                    <div class="contacto2"> <!-- Sección de contacto2 -->
                        <h4><?php echo $pageTranslations["txtSiguenos"]; ?></h4>
                        <a href="https://www.instagram.com/novaanalytics.cl/" target="_blank" id="enlaceIg" class="d-flex align-items-center mb-2">
                            ...
                            <span id="txtIg"><?php echo $pageTranslations["txtIg"]; ?></span>
                        </a>
                        <a href="https://web.facebook.com/Novaproduce.cl" target="_blank" id="enlaceFb" class="d-flex align-items-center mb-2">
                            ...
                            <span id="txtFb"><?php echo $pageTranslations["txtFb"]; ?></span>
                        </a>
                        <a href="https://www.linkedin.com/company/nova-analytic" target="_blank" id="enlaceIn" class="d-flex align-items-center">
                            ...
                            <span id="txtIn"><?php echo $pageTranslations["txtIn"]; ?></span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div id="contenedor-formulario" class="col-md-6 d-flex justify-content-center align-items-start">
                <div class="contenedorCotiza">
                    <form id="contactForm" action="#" method="POST">
                        <h1><?php echo $pageTranslations["txtFormulario"]; ?></h1>
                        <h5>___</h5>
    
                        <div class="mb-3">
                            <input type="text" id="name" name="name" class="form-control" placeholder="<?php echo $pageTranslations["txtNombre"]; ?>" required>
                        </div>
    
                        <div class="mb-3">
                            <input type="email" id="email" name="email" class="form-control" placeholder="<?php echo $pageTranslations["txtEmail"]; ?>" required>
                        </div>
    
                        <div class="mb-3">
                            <input type="text" id="company" name="company" class="form-control" placeholder="<?php echo $pageTranslations["txtEmpresa"]; ?>">
                        </div>
    
                        <div class="mb-3">
                            <input type="tel" id="phone" name="phone" class="form-control" placeholder="<?php echo $pageTranslations["txtCelular"]; ?>" required>
                        </div>
    
                        <div class="mb-3">
                            <textarea id="message" name="message" rows="5" class="form-control" placeholder="<?php echo $pageTranslations["txtMensaje"]; ?>" required></textarea>
                        </div>
    
                        <div id="prefContacto" class="mb-3">
                            <p><?php echo $pageTranslations["preferenciaContacto"]; ?></p>
                        </div>
                        ...
                        <div class="preferencia d-flex justify-content-start mb-4">
                            <div class="form-check me-3">
                                ...
                                <label for="contactPhone" class="form-check-label"><?php echo $pageTranslations["preferenciaContactoLlamada"]; ?></label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" id="contactEmail" name="contactPreference" value="email" class="form-check-input">
                                <label for="contactEmail" class="form-check-label"><?php echo $pageTranslations["preferenciaContactoCorreo"]; ?></label>
                            </div>
                        </div>
    
                        <button type="submit" class="btn btn-primary w-100 d-flex justify-content-center align-items-center">
                            <img src="imgs/iconos/mensaje.png" alt="Enviar" id="iconoMensaje" class="me-2"><?php echo $pageTranslations["txtEnviar"]; ?>
