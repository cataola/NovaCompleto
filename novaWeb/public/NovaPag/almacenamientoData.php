...
$pageTranslations = $translations['almacenamientoData']; // Obtén las traducciones específicas para la página principal
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Almacenamiento de Data - Nova Analytics</title>
    ...
    <main>
        <div id="bannerAgricola" class="container-fluid p-0 position-relative">
            ...
            <div  id="bannerAgricola-title" class="position-absolute top-50 start-50 translate-middle text-white">
                <h3 id="txtTitulo" class="fw-bold"><?php echo $pageTranslations["txtAlmacen1"]; ?> </h3>
            </div>
        </div>

        <div id="informacion-seccion">
            <div class="textos">
                <h3 id="txtServicio"><?php echo $pageTranslations["txtServicioAlma"]; ?></h3>
                <h1 id="txtTituloServicio"><?php echo $pageTranslations["txtAlmacen2"]; ?> </h1>
                <div class="txt">
                    <p id="parrafo">
                        <?php echo $pageTranslations["txtAlmacenTexto"]; ?>
                    </p>
                    <a id="cotizaAhora" href="#formulario-seccion" class="btnCotiza"><?php echo $pageTranslations["txtCotizar"]; ?></a>
                </div>
                <img src="imgs/cardsServicios/imgAlmacenamiento.png" alt="_blank">
            </div>
        </div>
            ...
            <div class="row w-100">
                ...
                <div id="contenedor-encuentranos" class="col-md-6 d-flex flex-column justify-content-start">
                    <div class="txtSeccion">
                        <h1 id="txtCotiza"><?php echo $pageTranslations["txtForm1"]; ?></h1>
                        <h5><?php echo $pageTranslations["txtForm2"]; ?></h5>
                        <p id="parrafoCotiza"><?php echo $pageTranslations["txtForm3"]; ?></p>
                    </div>
                    ...
                    <div id="container-encuentranos" class="d-flex">
                        <div class="contacto"> <!-- Espaciado a la derecha -->
                            <h4 id="encuentranos" class="small"><?php echo $pageTranslations["txtEncuentranos3"]; ?></h4>
                            <div class="d-flex align-items-center mb-2">
                                <img src="imgs/iconos/imgMensajeNaranjo.png" alt="Correo" id="imgCorreo" class="me-2">
                                <p id="txtCorreo" class="mb-0"><?php echo $pageTranslations["txtCorreo3"]; ?></p>
                            </div>
                            <div class="d-flex align-items-center">
                                <img src="imgs/iconos/imgTelefonoNaranjo.png" alt="Teléfono" id="imgTelefono" class="me-2">
                                <p id="txtTelefono" class="mb-0"><?php echo $pageTranslations["txtTelefono3"]; ?></p>
                            </div>
                        </div>
        
                        <div class="contacto2"> <!-- Sección de contacto2 -->
                            <h4 id="siguenos"><?php echo $pageTranslations["txtSiguenos3"]; ?></h4>
                            <a href="https://www.instagram.com/novaanalytics.cl/" target="_blank"id="enlaceIg" class="d-flex align-items-center mb-2">
                                ...
                                <span id="txtIg"><?php echo $pageTranslations["txtIg3"]; ?></span>
                            </a>
                            <a href="https://web.facebook.com/Novaproduce.cl" target="_blank"id="enlaceFb" class="d-flex align-items-center mb-2">
                                ...
                                <span id="txtFb"><?php echo $pageTranslations["txtFb3"]; ?></span>
                            </a>
                            <a href="https://www.linkedin.com/company/nova-analytic" target="_blank" id="enlaceIn" class="d-flex align-items-center">
                                ...
                                <span id="txtIn"><?php echo $pageTranslations["txtIn3"]; ?></span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div id="contenedor-formulario" class="col-md-6 d-flex justify-content-center align-items-start">
                    <div class="contenedorCotiza">
                        <form id="contactForm" action="#" method="POST">
                            <h1 id="txtFormulario"><?php echo $pageTranslations["txtFormulario3"]; ?></h1>
                            <h5><?php echo $pageTranslations["txtFormulario4"]; ?></h5>
        
                            <div class="mb-3">
                                <input type="text" id="name" name="name" class="form-control" placeholder=<?php echo $pageTranslations["txtNombre3"]; ?> required>
                            </div>
        
                            <div class="mb-3">
                                <input type="email" id="email" name="email" class="form-control" placeholder=<?php echo $pageTranslations["txtEmail3"]; ?> required>
                            </div>
        
                            <div class="mb-3">
                                <input type="text" id="company" name="company" class="form-control" placeholder=<?php echo $pageTranslations["txtEmpresa3"]; ?>>
                            </div>
        
                            <div class="mb-3">
                                <input type="tel" id="phone" name="phone" class="form-control" placeholder=<?php echo $pageTranslations["txtCelular3"]; ?> required>
                            </div>
        
                            <div class="mb-3">
                                <textarea id="message" name="message" rows="5" class="form-control" placeholder=<?php echo $pageTranslations["txtMensaje3"]; ?> required></textarea>
                            </div>
        
                            <div id="prefContacto" class="mb-3">
                                <p id="preferencia"><?php echo $pageTranslations["txtPreferenciaContacto3"]; ?></p>
                            </div>
                            ...
                            <div class="preferencia d-flex justify-content-start mb-4">
                                <div class="form-check me-3">
                                    ...
                                    <label for="contactPhone" class="form-check-label"><?php echo $pageTranslations["txtPreferenciaContactoLlamada13"]; ?></label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" id="contactEmail" name="contactPreference" value="email" class="form-check-input">
                                    <label for="contactEmail" class="form-check-label"><?php echo $pageTranslations["txtPreferenciaContactoCorreo3"]; ?></label>
                                </div>
                            </div>
                            ...
                            <button id="btnEnviar" type="submit" class="btn btn-primary w-100 d-flex justify-content-center align-items-center">
                                ...
                                <?php echo $pageTranslations["txtEnviar3"]; ?>
                            </button>
                        </form>
                    </div>
                </div>
